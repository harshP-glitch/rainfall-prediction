...
if uploaded_file:
    ...
    if missing_cols:
        ...
        # Add Yes/No classification for tooltip
        df["Rainfall_Yes_No"] = np.where(df["Predicted_Rainfall"] > 0.5, "Yes", "No")
        ...
        fig = px.scatter(df, x='Date', y='Predicted_Rainfall', color='Predicted_Rainfall',
                         ...
                         hover_data=features + ['Predicted_Rainfall', 'Rainfall_Yes_No'],
